            ...
            case 1:
                ...
                { // Solicita autenticacao.
                    ...
                    while (apresentar)
                    {
                        ...
                        int campo;
                        campo = getchar() - 48;
                        system("cls"); // Leitura do campo de entrada e conversao de ASCII.
                        //cin >>campo;
                        switch (campo)
                        {
                            case 1:
...
bool CntrApresentacaoHA::editarHospedagem() {
        ...
        char texto7[] = "Sucesso na modificacao. Digite algo.";
        char texto8[] = "Falha na modificacao. Digite algo.";
...
bool CntrApresentacaoHA::editarAvaliacao() {
    {
        ...
        char texto1[] = "Preencha os seguintes campos: ";
        char texto2[] = "Codigo da avaliacao que voce quer editar          :";
...
bool CntrApresentacaoHA::excluirAvaliacao() {
    ...
    string texto4 = "3 - Voltar";
    string texto6 = "Digite o codigo da Hospedagens que deseja visualizar: ";
    string texto7 = "Digite o codigo da Avaliacoes que deseja visualizar: ";
